...
public class ReflectiveMethodInvocation implements ProxyMethodInvocation, Cloneable {
	 ...
	 * aop拦截{@link MethodInterceptor}列表
	 */
	 ...
	 * 中调用
	 * </p>
	 * 构造器protected的,而不是public的
	 *
	 * @param proxy                                the proxy object that the invocation was made on
	 * @param target                               the target object to invoke 原始对象
	 * @param method                               the method to invoke 方法
	 * @param arguments                            the arguments to invoke the method with 方法参数
	 * @param targetClass                          the target class, for MethodMatcher invocations 原始对象class
	...
	public Object proceed() throws Throwable {
		...
		if (this.currentInterceptorIndex == this.interceptorsAndDynamicMethodMatchers.size() - 1) {
			/**
			 * 从-1开始,每次+1
			 * 如果这个判断成立,说明{@link ReflectiveMethodInvocation#interceptorsAndDynamicMethodMatchers}
			 * 都被执行了一遍
			 */
		...
		if (interceptorOrInterceptionAdvice instanceof InterceptorAndDynamicMethodMatcher) {
			...
			/**
			 * 这个地方可以参考{@link DefaultAdvisorChainFactory#getInterceptorsAndDynamicInterceptionAdvice(org.springframework.aop.framework.Advised, java.lang.reflect.Method, java.lang.Class)}
			 * 如果{@link MethodMatcher#isRuntime()}为true,则封装成这个对象
			 */
			 ...
			 *
			 * 通过{@link MethodInterceptor}形成了一个责任链模式
			 */
