...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
	...
	/**
	 * 在{@link AbstractEnvironment#AbstractEnvironment(org.springframework.core.env.MutablePropertySources)}
	 * 中被赋值
	 * {@link MutablePropertySources#MutablePropertySources()}
	 */
	private final MutablePropertySources propertySources;

	/**
	 * 在{@link AbstractEnvironment#AbstractEnvironment(org.springframework.core.env.MutablePropertySources)}中被赋值
	 * {@link PropertySourcesPropertyResolver#PropertySourcesPropertyResolver(org.springframework.core.env.PropertySources)}
	 */
	 ...
	 * <p>
	 * <p>
	 * 在{@link AbstractEnvironment#AbstractEnvironment()}中被调用
	 * </p>
	 *
	 * @param propertySources {@link MutablePropertySources#MutablePropertySources()}
	 * @see #customizePropertySources(MutablePropertySources)
	 * @since 5.3.4
	 */
	protected AbstractEnvironment(MutablePropertySources propertySources) {
		...
		/**
		 * {@link StandardEnvironment#customizePropertySources(org.springframework.core.env.MutablePropertySources)}
		 * 中有实现
		 */
	 ...
	 * 在{@link AbstractEnvironment#AbstractEnvironment(org.springframework.core.env.MutablePropertySources)}
	 * 中被调用
	 * 传递的参数为{@link MutablePropertySources#MutablePropertySources()}
	 *
