...
public class PropertySourcesPropertyResolver extends AbstractPropertyResolver {
	...
	/**
	 * 在{@link PropertySourcesPropertyResolver#PropertySourcesPropertyResolver(org.springframework.core.env.PropertySources)}
	 * 中被赋值
	 ...
	 * 在{@link AbstractEnvironment#createPropertyResolver(org.springframework.core.env.MutablePropertySources)}
	 * 中被调用
	 * 传递参数为{@link MutablePropertySources#MutablePropertySources()}
	 *
	 * @param propertySources the set of {@link PropertySource} objects to use  {@link MutablePropertySources#MutablePropertySources()}
	 */
