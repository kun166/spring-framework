...
public abstract class StringUtils {
	 ...
	 * 这个功能和{@link String#replaceAll(String, String)}的功能一样
	 * {@link StringUtils#cleanPath(java.lang.String)}中调用
	 *
	 * @param inString   {@code String} to examine 被替换的字符串
	 * @param oldPattern {@code String} to replace 要被替换的字符串格式,如\\
	 * @param newPattern {@code String} to insert 替换成的字符串格式,如/
	 ...
	 * 删除给定字符串中的charsToDelete字符
	 * 等价于 inString.replaceAll(charsToDelete,"");
	 * <p>
	 * 在{@link StringUtils#delimitedListToStringArray(java.lang.String, java.lang.String, java.lang.String)}中调用
	 * </p>
	 *
	 * @param inString      the original {@code String}
	 ...
	 * 重新整合路径，去掉路径中的.和..
	 * <p>
	 * {@link ClassPathResource#ClassPathResource(java.lang.String, java.lang.ClassLoader)}中调用
	 * </p>
	 *
	 ...
	 * str根据delimiter进行分割
	 * <p>
	 * {@link StringUtils#delimitedListToStringArray(java.lang.String, java.lang.String)}中调用
	 * </p>
	 *
	 * @param str           the input {@code String} (potentially {@code null} or empty)
	 * @param delimiter     the delimiter between elements (this is a single delimiter,
