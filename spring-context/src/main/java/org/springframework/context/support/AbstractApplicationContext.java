...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	 ...
	 * {@link AbstractApplicationContext#getEnvironment()}中被调用
	 * 赋值了{@link StandardEnvironment#StandardEnvironment()}
	 */
	@Nullable
	 ...
	 * {@link AbstractApplicationContext#AbstractApplicationContext()}中赋值
	 ...
	 * {@link AbstractApplicationContext#AbstractApplicationContext(org.springframework.context.ApplicationContext)}
	 * 中调用
	 */
	 ...
	 * <p>
	 * {@link AbstractRefreshableConfigApplicationContext#resolvePath(java.lang.String)}中被调用
	 * 返回了{@link StandardEnvironment#StandardEnvironment()}
	 */
	@Override
	 ...
	 * <p>
	 * {@link AbstractApplicationContext#AbstractApplicationContext()}中调用
	 *
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				// 事件广播
				// https://blog.csdn.net/qq_43203949/article/details/125471048
	...
	protected void initLifecycleProcessor() {
		// https://www.jianshu.com/p/4e0affad3103
		ConfigurableListableBeanFactory beanFactory = getBeanFactory();
