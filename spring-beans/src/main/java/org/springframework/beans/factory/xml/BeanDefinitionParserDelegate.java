...
public class BeanDefinitionParserDelegate {
	...
	/**
	 * {@link BeanDefinitionParserDelegate#BeanDefinitionParserDelegate(org.springframework.beans.factory.xml.XmlReaderContext)}
	 ...
	 * <p>
	 * 在{@link DefaultBeanDefinitionDocumentReader#createDelegate(org.springframework.beans.factory.xml.XmlReaderContext, org.w3c.dom.Element, org.springframework.beans.factory.xml.BeanDefinitionParserDelegate)}
	 * 处调用
	 * {@link XmlBeanDefinitionReader#createReaderContext(org.springframework.core.io.Resource)}
	 * </p>
	 */
	 ...
	 * <p>
	 * 在{@link BeanDefinitionParserDelegate#initDefaults(org.w3c.dom.Element, org.springframework.beans.factory.xml.BeanDefinitionParserDelegate)}
	 * 处调用
	 * </p>
	 *
	 ...
	 * {@link org.springframework.beans.factory.parsing.ProblemReporter}.
	 * <p>
	 * 在{@link BeanDefinitionParserDelegate#parseBeanDefinitionElement(org.w3c.dom.Element)}
	 * 中被调用
	 * </p>
	 */
	@Nullable
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, @Nullable BeanDefinition containingBean) {
		...
		if (StringUtils.hasLength(nameAttr)) {
			// 从这个判断来说,name可以为空，即不设置
			// name中可以含有,或者;分割的字符串，作为别名
		...
		if (!StringUtils.hasText(beanName) && !aliases.isEmpty()) {
			// 呃，如果id也没定义，但是定义了name,则取第一个别名为id
	...
	/**
	 * 校验beanName和beanElement是否已经被使用过了
	 * Validate that the specified bean name and aliases have not been used already
	 * within the current level of beans element nesting.
	 * <p>
	 * 在{@link BeanDefinitionParserDelegate#parseBeanDefinitionElement(org.w3c.dom.Element, org.springframework.beans.factory.config.BeanDefinition)}
	 * 中调用
	 * </p>
	 */
	 ...
	 * <p>
	 * {@link BeanDefinitionParserDelegate#parseBeanDefinitionElement(org.w3c.dom.Element, org.springframework.beans.factory.config.BeanDefinition)}
	 * 中调用
	 * </p>
	 */
	@Nullable
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		String parent = null;
		// parent
		// 可以参考https://www.cnblogs.com/ssh-html/p/10740946.html
		...
		try {
			/**
			 * 返回的是{@link GenericBeanDefinition}
			 */
			AbstractBeanDefinition bd = createBeanDefinition(className, parent);

			/**
			 * 解析<bean>标签的attribute
			 * 如:
			 * "scope"
			 * "abstract"
			 * "lazy-init"
	...
	public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName,
		...
		// depends-on
		// 参考:https://blog.csdn.net/u010285974/article/details/107428468
	...
	public void parseMetaElements(Element ele, BeanMetadataAttributeAccessor attributeAccessor) {
		...
		for (int i = 0; i < nl.getLength(); i++) {
			...
			/**
			 * 关于bean 的meta,可以参考
			 * https://blog.csdn.net/u014252478/article/details/84590067
			 */
	...
	public void parseLookupOverrideSubElements(Element beanEle, MethodOverrides overrides) {
		...
		for (int i = 0; i < nl.getLength(); i++) {
			Node node = nl.item(i);
			// lookup-method
			// https://blog.csdn.net/chenzoff/article/details/124165865
	 ...
	 * <p>
	 * {@link BeanDefinitionParserDelegate#parseConstructorArgElements(org.w3c.dom.Element, org.springframework.beans.factory.config.BeanDefinition)}
	 * 中调用
	 * </p>
	 * 解析{@link BeanDefinitionParserDelegate#CONSTRUCTOR_ARG_ELEMENT}标签
	 */
			...
			try {
				...
				if (index < 0) {
					...
					try {
						...
						/**
						 * 封装成了{@link ConstructorArgumentValues.ValueHolder}对象
						 */
	 ...
	 * {@link BeanDefinitionParserDelegate#parsePropertyElements(org.w3c.dom.Element, org.springframework.beans.factory.config.BeanDefinition)}
	 * 中调用
	 */
	 ...
	 * {@link BeanDefinitionParserDelegate#parseQualifierElements(org.w3c.dom.Element, org.springframework.beans.factory.support.AbstractBeanDefinition)}
	 * 中被调用
	 */
	...
	public Object parsePropertyValue(Element ele, BeanDefinition bd, @Nullable String propertyName) {
		...
		if (hasRefAttribute) {
			...
			/**
			 * ref返回的是{@link RuntimeBeanReference}
			 */
			...
			/**
			 * 如果是value,返回的是{@link TypedStringValue}
			 */
	 ...
	 * constructor-arg element.
	 * <p>
	 * {@link BeanDefinitionParserDelegate#parsePropertyValue(org.w3c.dom.Element, org.springframework.beans.factory.config.BeanDefinition, java.lang.String)}
	 * 中调用
	 * </p>
	 *
	 ...
	 * constructor-arg element.
	 * <p>
	 * {@link BeanDefinitionParserDelegate#parsePropertySubElement(org.w3c.dom.Element, org.springframework.beans.factory.config.BeanDefinition)}
	 * 中调用
	 * </p>
	 * 解析<property></property>
	 * 或者是<constructor-arg></constructor-arg>
	 * 子标签
	 *
	 * @param ele              subelement of property element; we don't know which yet
	 * @param bd               the current bean definition (if any)
	...
	public Object parsePropertySubElement(Element ele, @Nullable BeanDefinition bd, @Nullable String defaultValueType) {
		if (!isDefaultNamespace(ele)) {
			...
			/**
			 * ref标签。
			 * 关于parent标签，可以参阅: https://www.cnblogs.com/CloudComputing-binbin/p/15939822.html
			 * 取 bean 的标签值
			 */
	...
	/**
	 * <p>
	 * {@link BeanDefinitionParserDelegate#parsePropertySubElement(org.w3c.dom.Element, org.springframework.beans.factory.config.BeanDefinition, java.lang.String)}
	 * 中调用
	 * </p>
	 *
	 * @param ele
	...
	private BeanDefinitionHolder parseNestedCustomElement(Element ele, @Nullable BeanDefinition containingBd) {
		...
		/**
		 * 返回一个{@link BeanDefinitionHolder}
		 */
	 ...
	 * <p>
	 * {@link BeanDefinitionParserDelegate#isDefaultNamespace(org.w3c.dom.Node)}
	 * </p>
	 *
	 * @param node the node
	 */
	 ...
	 * <p>
	 * {@link BeanDefinitionParserDelegate#parseMetaElements(org.w3c.dom.Element, org.springframework.beans.BeanMetadataAttributeAccessor)}
	 * 中调用
	 * </p>
	 *
	 ...
	 * {@link BeanDefinitionParserDelegate#isDefaultNamespace(org.w3c.dom.Node)}
	 * </p>
	 * 传入的namespaceUri为空，或者是等于{@link BeanDefinitionParserDelegate#BEANS_NAMESPACE_URI}
	 */
